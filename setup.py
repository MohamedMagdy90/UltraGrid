...
def main():
    ...
    setup(
        name="ultraboost",
        version=version,
        description="UltraBoost - Automated Trading Framework by BoostNova",
        url="https://github.com/boostnova/ultraboost",
        author="BoostNova",
        author_email="dev@boostnova.bot",
        license="Apache 2.0",
        packages=packages,
